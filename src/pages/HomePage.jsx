  ...
  return (
    <div className="min-h-[calc(100vh-100px)] flex flex-col justify-center items-center py-10 px-4 sm:px-6 lg:px-8">
      ...
      <section className="text-center mb-12 max-w-4xl mx-auto ">
        ...
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-l from-violet-600 to-teal-600 mb-4 sm:mb-10 leading-tight drop-shadow-sm"> {/* Ukuran font lebih kecil */}
      ...
      <section className="w-full max-w-5xl mx-auto mt-16 py-12 bg-white rounded-lg shadow-lg">
        <h3 className="text-3xl font-bold text-violet-700 text-center mb-10">Fitur Unggulan Kami</h3>
